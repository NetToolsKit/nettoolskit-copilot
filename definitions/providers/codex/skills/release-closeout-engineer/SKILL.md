...
6. Load `.github/instructions/governance/ntk-governance-feedback-changelog.instructions.md`.
7. Load `.github/instructions/governance/ntk-governance-readme.instructions.md` when README files are in scope.
