...
- If editing code: select the domain instruction file(s) under `instructions/` that match the language/folder (e.g., `instructions/architecture/backend/ntk-backend-dotnet-csharp.instructions.md`, `ntk-backend-architecture-platform.instructions.md`, `ntk-data-database.instructions.md`, etc).
