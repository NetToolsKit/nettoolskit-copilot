...
- For non-trivial work, route first and then follow `instructions/governance/ntk-governance-subagent-planning-workflow.instructions.md`.
...
Full protocol, compression triggers, six-block state model, CHECKPOINT format, and user commands: `instructions/development/ntk-development-agentic-context-economy-checkpoint.instructions.md`.
