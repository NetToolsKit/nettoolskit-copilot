...
- [database.instructions.md](../instructions/data-security/ntk-data-database.instructions.md) - Database standards
- [orm.instructions.md](../instructions/data-security/ntk-data-orm.instructions.md) - EF Core patterns
- [backend.instructions.md](../instructions/architecture/backend/ntk-backend-architecture-platform.instructions.md) - Backend integration
