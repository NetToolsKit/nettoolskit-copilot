...
- ✅ Versioned control-plane inspection schemas for AI profile inventory, doctor, healthcheck, self-heal, and local recall machine output
...
| `ntk runtime healthcheck` | Run the native runtime healthcheck workflow, with human-readable output or a typed JSON control schema |
| `ntk runtime self-heal` | Run the native runtime self-heal workflow, with human-readable output or a typed JSON control schema |
...
| Current typed surfaces | Read-only AI/runtime inspection, AI profile inventory, and local recall with versioned machine-readable contracts | `ntk ai doctor`, `ntk ai profiles list`, `ntk ai profiles show`, `ntk runtime doctor`, `ntk runtime healthcheck`, `ntk runtime self-heal`, `ntk runtime query-local-context-index`, `ntk runtime query-local-memory` |
