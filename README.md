...
- ✅ Built-in AI provider profiles plus `ntk ai doctor` diagnostics, smart routing strategy scoring, and normalized adapter contracts for balanced, coding, cheap, latency, and local orchestrator presets
