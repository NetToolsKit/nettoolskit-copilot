...
- [planning/specs/completed/spec-instruction-taxonomy-and-path-refactor.md](planning/specs/completed/spec-instruction-taxonomy-and-path-refactor.md)
- [planning/specs/completed/spec-provider-surface-projection-cutover.md](planning/specs/completed/spec-provider-surface-projection-cutover.md)
- [planning/specs/completed/spec-development-agent-orchestrator-experience.md](planning/specs/completed/spec-development-agent-orchestrator-experience.md)
- [planning/specs/completed/spec-free-llm-provider-test-matrix.md](planning/specs/completed/spec-free-llm-provider-test-matrix.md)
...
- [planning/specs/completed/spec-script-retirement-phase-22-orchestration-sweep.md](planning/specs/completed/spec-script-retirement-phase-22-orchestration-sweep.md)
- [planning/specs/completed/spec-script-retirement-tail-cutover.md](planning/specs/completed/spec-script-retirement-tail-cutover.md)
- [planning/specs/completed/spec-repository-consolidation-continuity.md](planning/specs/completed/spec-repository-consolidation-continuity.md)
