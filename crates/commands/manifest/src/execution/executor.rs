...
impl ManifestExecutor {
    ...
    async fn execute_async(
        ...
        if !solution_root.exists() {
            ...
            crate::execution::files::ensure_directory(
                &solution_root,
                config.dry_run,
                &mut summary,
                "solution root",
        ...
        crate::execution::files::execute_plan(changes, config.dry_run, &mut summary)?;
    ...
    fn collect_render_tasks(
        manifest: &ManifestDocument,
    ) -> ManifestResult<Vec<crate::core::models::RenderTask>> {
        ...
        match manifest.apply.mode {
            ApplyModeKind::Artifact => {
                ...
                let kind = crate::core::models::ArtifactKind::parse_kind(&artifact_cfg.kind);
            ...
            ApplyModeKind::Layer => {
                ...
                let contexts: Vec<&crate::core::models::ManifestContext> =
    ...
    fn select_contexts<'a>(
        contexts: &'a [crate::core::models::ManifestContext],
        name: Option<&str>,
    ) -> Vec<&'a crate::core::models::ManifestContext> {
        match name {
