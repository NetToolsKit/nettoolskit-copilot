...
use crate::support::deploy_fixtures::{
    initialize_deploy_preflight_repo, write_valid_deploy_layout,
};
...
#[test]
fn test_invoke_validate_all_runs_native_security_baseline_check() {
    let repo = TempDir::new().expect("temporary repository should be created");
    initialize_repo_layout(repo.path(), &["validate-security-baseline"]);
...
#[test]
fn test_invoke_validate_all_runs_native_compatibility_lifecycle_policy_check() {
    let repo = TempDir::new().expect("temporary repository should be created");
    initialize_repo_layout(repo.path(), &["validate-compatibility-lifecycle-policy"]);
...
#[test]
fn test_invoke_validate_all_runs_native_shared_script_checksums_check() {
    let repo = TempDir::new().expect("temporary repository should be created");
    initialize_repo_layout(repo.path(), &["validate-shared-script-checksums"]);
...
#[test]
fn test_invoke_validate_all_runs_native_release_governance_check() {
    let repo = TempDir::new().expect("temporary repository should be created");
    initialize_repo_layout(repo.path(), &["validate-release-governance"]);
...
#[test]
fn test_invoke_validate_all_runs_native_deploy_preflight_check() {
    let repo = TempDir::new().expect("temporary repository should be created");
    initialize_repo_layout(repo.path(), &["validate-deploy-preflight"]);
...
#[test]
fn test_invoke_validate_all_runs_native_agent_permissions_check() {
    let repo = TempDir::new().expect("temporary repository should be created");
    initialize_repo_layout(repo.path(), &["validate-agent-permissions"]);
...
#[test]
fn test_invoke_validate_all_runs_native_agent_orchestration_check() {
    let repo = TempDir::new().expect("temporary repository should be created");
    initialize_repo_layout(repo.path(), &["validate-agent-orchestration"]);
    initialize_agent_contract_repo(repo.path());
