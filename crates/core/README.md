...
- ✅ Versioned machine-readable control schemas for `ai_doctor`, `ai_provider_profiles`, `ai_provider_profile`, `runtime_doctor`, `runtime_healthcheck`, `runtime_self_heal`, `local_context_query`, and `local_memory_query`
