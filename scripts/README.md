...
| `validation/validate-instruction-architecture.ps1` | Validates ownership boundaries between the global core, repository operating model, domain instructions, prompts, templates, skills, and runtime/orchestration assets. | `pwsh -File scripts/validation/validate-instruction-architecture.ps1` |
