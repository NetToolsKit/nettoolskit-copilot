...
| `validation/validate-planning-structure.ps1` | Validates the versioned planning workspace under `.temp/planning/`, including required folders, README, and `.gitignore` exceptions. | `pwsh -File scripts/validation/validate-planning-structure.ps1 -RepoRoot .` |
