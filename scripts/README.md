...
| `common/repository-paths.ps1` | Shared repository helper for root discovery, repo-relative path resolution, parent directory handling, verbose diagnostics, and structured execution logging used by critical runtime/audit scripts. | `. ./scripts/common/repository-paths.ps1` |
