...
'@
        ...
        Assert-Equal -Actual $newDocument.settings.'chat.agent.maxRequests' -Expected 400 -Message 'Workspace creation must keep the workspace-local chat.agent.maxRequests cap.'
