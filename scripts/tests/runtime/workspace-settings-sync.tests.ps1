...
'@
        ...
        Assert-Equal -Actual $existingDocument.settings.'workbench.startupEditor' -Expected 'agentSessionsWelcomePage' -Message 'Workspace sync must open on the chat sessions welcome page.'
        ...
        Assert-Equal -Actual $newDocument.settings.'workbench.startupEditor' -Expected 'agentSessionsWelcomePage' -Message 'Workspace creation must open on the chat sessions welcome page.'
